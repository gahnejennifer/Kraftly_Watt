...
describe('test validateMove', () => {
    ...
    it('should return invalid if the move date is less than 14 days away', () => {
        const moveForm = { address: 'Testgatan 1', zip: '80267', city: 'Gävle', date: '31.08.2026', contract: 'Rörligt pris' }
    ...
    it('should return valid if the move date is at least 14 days away', () => {
        const moveForm = { address: 'Testgatan 1', zip: '80267', city: 'Gävle', date: '2026-09-12', contract: 'Rörligt pris' }
